...
\textbf{SOV-8 (Environmental):} OTC scores 88\% against T Cloud Public's 100\%. The difference is limited to Q3 (carbon and water disclosures): T Cloud Public receives \textit{Yes} because Deutsche Telekom's 2024 Corporate Responsibility Report (externally assured, CSRD-compliant) includes per-data-centre PUE figures and full Scope 1--3 GHG disclosures; OTC receives \textit{Partial} because OTC-specific Water Usage Effectiveness metrics are not published at the product level.
